    ...
    dashboards: [
      {
        ...
        description: 'Administrative control panel for managing exam content, AI parameters, and student performance monitoring.',
      },
      {
        type: 'user',
        title: 'Course Section View',
        imagePath: '/images/FreshApp-dashboards/course-section.jpg',
        description: 'Student course interface with organized learning materials and progress tracking.',
      },
      {
        type: 'analytics',
        title: 'Exam Content Management',
        imagePath: '/images/FreshApp-dashboards/exam-section.jpg',
      ...
      },
      {
        ...
        imagePath: '/images/FreshApp-dashboards/gpa-calculator.jpg',
        description: 'Real-time GPA calculation tool with semester tracking and grade predictions.',
      },
    ],
    features: [
      {
    ...
    dashboards: [
      {
        ...
        description: 'System administration with user management, content moderation, and platform analytics.',
      },
      {
        type: 'user',
        title: 'Question & Answer Interface',
        imagePath: '/images/HuConnect-dashboards/question-answer.jpg',
        description: 'Interactive Q&A platform where students ask questions and receive peer-verified answers.',
      },
      {
        type: 'analytics',
        title: 'Profile & Analytics',
        imagePath: '/images/HuConnect-dashboards/profile-analytics.jpg',
        description: 'User profile with reputation tracking, contribution history, and engagement metrics.',
      },
      {
        type: 'manager',
        title: 'Tag Management System',
        imagePath: '/images/HuConnect-dashboards/tag-managment.jpg',
        description: 'Smart categorization system for organizing questions by department and topic.',
      },
    ],
    features: [
      {
